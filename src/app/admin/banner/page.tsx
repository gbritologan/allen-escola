 ...
 * O BANNER DA HOME.
 *
 * A medida (3200×640, 5:1) está escrita aqui e no componente porque é a única
 * arte do produto feita FORA do produto. Medida que mora só na cabeça de quem
 * programou volta errada do designer.
 *
 * A largura é o DOBRO da moldura de propósito — ver o componente para o
 * porquê. Resumo: tela de densidade 2× pede dois pixels por ponto, e arte
 * menor que isso o navegador estica.
 *
    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-10 px-6 py-10 lg:px-10">
      <header className="flex flex-col gap-2">
        ...
        <p className="max-w-[64ch] text-body text-ink-3">
          ...
          <strong className="font-medium text-ink-2">3200×640 (5:1)</strong>. A largura é o
          dobro da moldura de propósito: tela de Mac tem densidade 2×, e arte menor que isso o
          navegador estica — é o que serrilha. JPG, PNG, WebP ou
